...
#else
#define expect_rel(x, op, y, fmtargs...)    ( _USE(x), _USE(y), true )
#define expect_imply(x, y, fmtargs...)	    ( _USE(x), _USE(y), true )
#define expect_noerr(err, fmtargs...)	    ( _USE(err), true )
#define expect_rc(rc, call, fmtargs...)	    ( _USE(rc), true )
#endif
